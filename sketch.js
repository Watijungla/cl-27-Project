...
function setup() {
	...
	chain = new Chain(bob3.Body,{x:400,y:100})
	chain = new Chain(bob3.Body,{x:450,y:100})
	chain = new Chain(bob4.Body,{x:500,y:100})
	chain = new Chain(bob5.Body,{x:550,y:100})
...
function draw() {
 ...
 function keyPressed() {
	 if(keyCode === UP_ARROW) {
		...
		Matter.Body.applyForce(bob1.body,bob1.podition,{x:30,y:155});
